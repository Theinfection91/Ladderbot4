...
{
    [Group("ladder", "Slash commands related to overall ladder management (start/end, designated channels stats, etc.)")]
    public class LadderStatesSlashCommands : InteractionModuleBase<SocketInteractionContext>
    {
        ...
        public async Task StartLadderAsync([Summary("division", "The division of Ladder to try and start (1v1, 2v2, 3v3)")]string division)
        {
